...
/**
 * \file    test/phpunit/TunisiaelinvFunctionalTest.php
...
/**
 * Class TunisiaelinvFunctionalTest
 *
 ...
 *
 * @package Testtunisiaelinv
 */
class TunisiaelinvFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTunisiaelinv')->click();
		} else {
			// Disable the module
			$this->byHref('modTunisiaelinv')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/tunisiaelinv/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('tunisiaelinv/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/tunisiaelinv/admin/about.php');
		$this->authenticate();
		return $this->assertContains('tunisiaelinv/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('tunisiaelinvwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTunisiaelinv_TunisiaelinvTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTunisiaelinv_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
